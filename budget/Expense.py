...
class Expenses:
    ...
    def categorize_for_loop(self):
        ...
        for i in self.list:
            if (
                    i.category == 'Phone' or i.category == 'Auto and Gas' or i.category == 'Classes' or i.category == 'Utilities' or i.category == 'Mortgage'):
    ...
    def categorize_set_comprehension(self):
        necessary_expenses = {x for x in self.list
                              if x.category == 'Phone' or x.category == 'Classes' or x.category == 'Auto and Gas' or x.category == 'Utilities' or x.category == 'Mortgage'}
